...
public class about_test extends AppCompatActivity {

    @BindView(R.id.about_test)
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readRawTextFile readText = new readRawTextFile(this, getResources().getIdentifier("v2", "raw", "com.AdviceForParents.advice"));
